...
#read_and_proc.save_to_pickle('../tmp/mcdrop/'+str(expname)+'/0/'+str(droprate)+'/'+str(splitnum)+'/bestparams.pkt',study,'PICKLE')
...
for i in range(len(times)):
    ...
    torch.save(models, '../tmp/mcdrop/'+str(expname)+'/0/'+str(droprate)+'/'+str(splitnum)+'/modelstest'+str(splitnum)+'_lwswts_1115_'+str(times[i])+'.pt')
    read_and_proc.save_to_pickle('../tmp/mcdrop/'+str(expname)+'/0/'+str(droprate)+'/'+str(splitnum)+'/lossestest'+str(splitnum)+'_lwswts_1115_'+str(times[i])+'.pkt',losses,'PICKLE')
